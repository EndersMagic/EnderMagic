...
public class TechnicalEnderite extends Default implements IMetaBlockName {
	
	public static final PropertyEnum TYPE = PropertyEnum.create("type", EnumType.class);
	
	public TechnicalEnderite() {
		super(Material.IRON, "tech_enderite", "pickaxe", 2);	
		setDefaultState(blockState.getBaseState().withProperty(TYPE, EnumType.HARDENED));
	}
