...
public class EnderSapling extends BlockBush implements IGrowable {
    ...
    public void generateTree(World world, BlockPos pos, IBlockState state, Random rand) {
        ...
        switch ((EnumType)state.getValue(TYPE)) {
            ...
            case NATURAL:
                ...
                break;
            case IMMORTAL:
                worldgenerator = new WorldGenTrees(true, 3, ListBlock.ENDER_LOGS.getDefaultState().withProperty(EnderLogs.TYPE, EnumType.NATURAL), ListBlock.ENDER_LEAVES.getDefaultState().withProperty(EnderLeaves.TYPE, EnumType.NATURAL), false);
                flag = true;
                break;
            case VANISHING:
                worldgenerator = new WorldGenTrees(true, 3, ListBlock.ENDER_LOGS.getDefaultState().withProperty(EnderLogs.TYPE, EnumType.VANISHING), ListBlock.ENDER_LEAVES.getDefaultState().withProperty(EnderLeaves.TYPE, EnumType.VANISHING), false);
                flag = true;
                break;
        }
    ...
    public IBlockState getStateFromMeta(int meta) {
        return getDefaultState().withProperty(TYPE, EnumType.values()[meta & 7]).withProperty(STAGE, Integer.valueOf((meta & 8) >> 3));
    }
