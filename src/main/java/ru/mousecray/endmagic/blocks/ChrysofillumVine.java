...
public class ChrysofillumVine extends EMBlockBush {
	...
	protected boolean canSustainBush(IBlockState state) {
		return state.getBlock() == EMBlocks.chrysVine || (state.getBlock() == EMBlocks.enderLog && state.getValue(((EMLog)state.getBlock()).getVariantType()) == EnderBlockTypes.EnderTreeType.NATURAL);
	}
