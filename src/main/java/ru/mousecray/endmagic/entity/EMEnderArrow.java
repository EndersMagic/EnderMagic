...
public class EMEnderArrow extends EntityArrow {
    ...
    public EMEnderArrow(World world) {
        super(world);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public EMEnderArrow(World world, double x, double y, double z) {
        this(world);
        setPosition(x, y, z);
    }

    public EMEnderArrow(World world, EntityLivingBase shooter) {
    ...
    protected void onHit(RayTraceResult raytraceResult) {
        ...
        if (entity != null) {
            ...
            if (shootingEntity == null) damagesource = EndMagicData.causeArrowDamage(this, this);
            else damagesource = EndMagicData.causeArrowDamage(this, this);
    ...
    protected ItemStack getArrowStack() {
		return new ItemStack(ListItem.ENDER_ARROW);
	}
}
