...
public class EMMaterials {
    ...
    public static final Item.ToolMaterial NATURAL_STEEL_TOOL_MATERIAL =
            EnumHelper.addToolMaterial("em_natural_steel", 2, 500, 7, 2, 12);
    public static final Item.ToolMaterial PHANTOM_STEEL_TOOL_MATERIAL =
            EnumHelper.addToolMaterial("em_phantom_steel", 3, 1000, 7, 2.5F, 12);
    public static final Item.ToolMaterial DRAGON_STEEL_TOOL_MATERIAL =
            EnumHelper.addToolMaterial("em_dragon_steel", 3, 1500, 8, 3, 12);
    public static final Item.ToolMaterial IMMORTAL_STEEL_TOOL_MATERIAL =
            EnumHelper.addToolMaterial("em_immortal_steel", 3, 2000, 7, 4F, 12);

    public static final Item.ToolMaterial NATURAL_DIAMOND_TOOL_MATERIAL =
            EnumHelper.addToolMaterial("em_natural_diamond", 3, 1000, 8, 3F, 20);
    public static final Item.ToolMaterial PHANTOM_DIAMOND_TOOL_MATERIAL =
            EnumHelper.addToolMaterial("em_phantom_diamond", 4, 2000, 9, 4, 20);
    public static final Item.ToolMaterial DRAGON_DIAMOND_TOOL_MATERIAL =
            EnumHelper.addToolMaterial("em_dragon_diamond", 4, 3000, 10, 5, 22);
    public static final Item.ToolMaterial IMMORTAL_DIAMOND_TOOL_MATERIAL =
            EnumHelper.addToolMaterial("em_immortal_diamond", 5, 4000, 12, 10, 22);

    public static final ItemArmor.ArmorMaterial NATURAL_STEEL_ARMOR_MATERIAL =
    ...
    public static final ItemArmor.ArmorMaterial PHANTOM_STEEL_ARMOR_MATERIAL =
    ...
    public static final ItemArmor.ArmorMaterial DRAGON_STEEL_ARMOR_MATERIAL =
    ...
    public static final ItemArmor.ArmorMaterial IMMORTAL_STEEL_ARMOR_MATERIAL =
