...
import ru.mousecray.endmagic.gameobj.items.*;
import ru.mousecray.endmagic.gameobj.items.materials.EnderCoal;
import ru.mousecray.endmagic.gameobj.items.materials.EnderDiamond;
import ru.mousecray.endmagic.gameobj.items.materials.EnderSteel;
import ru.mousecray.endmagic.gameobj.items.materials.MaterialProvider;
import ru.mousecray.endmagic.gameobj.items.tools.EMArmor;
import ru.mousecray.endmagic.gameobj.items.tools.EMAxe;
import ru.mousecray.endmagic.gameobj.items.tools.EMHoe;
import ru.mousecray.endmagic.gameobj.items.tools.EMPickaxe;
import ru.mousecray.endmagic.gameobj.items.tools.EMShovel;
import ru.mousecray.endmagic.gameobj.items.tools.EMSword;
