...
public interface IFeaturesList extends IStringSerializable {
    ...
    @Nonnull
    static IFeaturesList EMPTY(String stateName) {
    ...
    default boolean isSubtypeSource() {
    ...
    default MapColor getMapColor(IBlockAccess world, BlockPos pos) {
        throw new UnsupportedOperationException();
    }

    default float getHardness(World world, BlockPos pos) {
        throw new UnsupportedOperationException();
    }
    ...
    default SoundType getSoundType(World world, BlockPos pos, Entity entity) {
        throw new UnsupportedOperationException();
    }
    ...
    default int quantityDropped(int fortune, Random rand) {
        throw new UnsupportedOperationException();
    }

    default BlockFaceShape getFaceShape(IBlockAccess world, BlockPos pos, EnumFacing facing) {
        throw new UnsupportedOperationException();
    }

    @Nullable
    default AxisAlignedBB getCollisionAABB(IBlockAccess world, BlockPos pos) {
        throw new UnsupportedOperationException();
    }

    @Nullable
    default AxisAlignedBB getSelectedAABB(IBlockAccess world, BlockPos pos) {
        throw new UnsupportedOperationException();
    }
    ...
    default int getWeakPower(IBlockAccess world, BlockPos pos, EnumFacing side) {
        throw new UnsupportedOperationException();
    }

    default int getStrongPower(IBlockAccess world, BlockPos pos, EnumFacing side) {
        throw new UnsupportedOperationException();
    }
